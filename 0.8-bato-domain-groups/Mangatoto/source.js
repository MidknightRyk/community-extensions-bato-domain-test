...
var _Sources = (() => {
  ...
  // src/Mangatoto/external/crypto-js.min.js
  var require_crypto_js_min = __commonJS({
    "src/Mangatoto/external/crypto-js.min.js"(exports, module) {
      "use strict";
      !function(t, e) {
  ...
  // src/Mangatoto/MangatotoParser.ts
  var import_types = __toESM(require_lib());

  // src/Mangatoto/MangatotoHelper.ts
  ...
  // src/Mangatoto/MangatotoSettings.ts
...
Please go to the homepage of <${_BatoTo.name}> and press the cloud icon.`
  ...
  return __toCommonJS(Mangatoto_exports);
})();
